...
// 5 attempts per 15 mins (900s) for login and token rotation
const loginLimiter = createRateLimiter('login', 5, 900, 'Too many login attempts. Please try again in 15 minutes.');
const sessionLimiter = createRateLimiter('session', 10, 900, 'Too many session requests. Please try again later.');
